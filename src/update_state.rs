...
impl<'a> UpdateState<'a> {
    pub fn new(delta_time: f32, input: &'a Input, message_bus: SharedMessageBus, queue: ThreadSafeJobQueue) -> UpdateState<'a> {
        UpdateState { delta_time, input, message_bus, queue }
    }
